...
<HTML><HEAD><TITLE>Related Links</TITLE></HEAD>
<BODY bgColor=#006699 text=#000000>
<FORM action="ValidateDoctor.jsp" method=post>
          ...
          <TD>
            <TABLE border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                vAlign=center background=images/buttonmiddle.gif class=tabs><font color="#FFFFFF">Applications</font></TD>
                <TD align="center" vAlign=center><IMG alt="" height=30 
                  src="images/buttonright.gif" width=10></TD>
                <TD align="center" vAlign=center><IMG alt="" height=30 
                  src="images/buttonleft.gif" width=9></TD>
        ...
        <TR>
                <TD vAlign=top> <div align="center">
                    <table width="100%" height="10" border="1" cellpadding="0" cellspacing="0">
                      ...
                      <td> <div align="center"><strong>Confirmation for Phone 
                          Transfer Request</strong></div></td>
                      </tr>
                    </table>
                  ...
                  <table width="100%" height="186" border="0">
                    <tr> 
                      <td align="center" valign="middle"><blockquote>
                          <p>Your Application has been accepted and will be processed 
                            and you will be informed about the status.<br>
                            <br>
                            Your Request ID is <%= request.getAttribute("request_id")%>.<br>
                            <br>
                            Use this Request ID and Password (Entered in the application 
                            form) for further enquiries.<br>
                            <br>
                            <em> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
