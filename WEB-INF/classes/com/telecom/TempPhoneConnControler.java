...
public class TempPhoneConnControler extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
		...
		cdm.setFromDate(request.getParameter("fday")+"-"+request.getParameter("fmonth")+"-"+request.getParameter("fyear"));
		cdm.setToDate(request.getParameter("tday")+"-"+request.getParameter("tmonth")+"-"+request.getParameter("tyear"));
