...
<HTML><HEAD><TITLE>Telecom Services</TITLE></HEAD>
<BODY bgColor=#006699 text=#000000>
<FORM action="ComplaintsControler" method=post>
          ...
          <TD>
            <TABLE border=0 cellPadding=0 cellSpacing=0>
              ...
              <TR>
                ...
                vAlign=center background=images/buttonmiddle.gif class=tabs><font color="#FFFFFF">Home</font></TD>
            ...
            <TR> 
              <TD vAlign=top> <div align="center"> 
                  <table width="100%" height="10" border="1" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td> <div align="center"><strong>Complaints Confirmation</strong></div></td>
                    </tr>
                  </table>
                  <table width="100%" height="125" border="0">
                    <tr>
                      <td height="121" align="center" valign="top"><br>
                        Your Complaint has been recived and will be Considered.<br>
                        <br>
                        <br>
                        Your Complaint ID is <%=request.getAttribute("complaint_id") %></td>
                    </tr>
                  </table>
                </div></TD>
            </TR>
